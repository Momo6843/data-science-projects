# Projets en Data Science et Machine Learning

Ce dépôt regroupe plusieurs projets en data science et machine learning
réalisés en Python. Ils couvrent les principales étapes d’un projet data :
préparation des données, analyse exploratoire, modélisation, évaluation
et interprétation des résultats.

Les projets s’appuient sur des jeux de données concrets et abordent
des problématiques réelles telles que la détection de fraude,
le déséquilibre des classes, la réduction de dimension et
...
## Remarque
Ces projets ont été réalisés dans un cadre académique et personnel
dans un objectif d’apprentissage et de mise en pratique des méthodes
de data science et de machine learning.
